...
class _PageQuizzState extends State<PageQuizz>{
  ...
  Future<Null> dialogue(bool b) async{
    ...
    return showDialog(context: context, barrierDismissible: false, builder: (BuildContext context){
      return new SimpleDialog(
        title: new CustomText((bonneReponse)? "C'est gagne": "Oups! Perdu", factor: 1.4, color: (bonneReponse)? Colors.green : Colors.red),
        contentPadding: EdgeInsets.all(20.0),
        children: <Widget>[
          new Image.asset((bonneReponse)? vrai : faux,
          fit: BoxFit.cover,),
          ...
          child: new CustomText("Au suivant", factor:1.25, color:Colors.blue),)
        ],
      );
    }
    );
  ...
  Future<Null> alerte()async{
    return showDialog(context: context,
      ...
      return new AlertDialog(title: new CustomText("C'est fini!", color:Colors.blue, factor:1.25,),
